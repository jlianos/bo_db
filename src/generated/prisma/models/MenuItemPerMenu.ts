...
// @ts-nocheck 
/*
 * This file exports the `MenuItemPerMenu` model and its related types.
 *
...
export type GetMenuItemPerMenuAggregateType<T extends MenuItemPerMenuAggregateArgs> = {
      [P in keyof T & keyof AggregateMenuItemPerMenu]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateMenuItemPerMenu[P]>
    : Prisma.GetScalarType<T[P], AggregateMenuItemPerMenu[P]>
}
...
export type GetMenuItemPerMenuGroupByPayload<T extends MenuItemPerMenuGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<MenuItemPerMenuGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof MenuItemPerMenuGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], MenuItemPerMenuGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], MenuItemPerMenuGroupByOutputType[P]>
      }
    >
  >
...
export type MenuItemPerMenuCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<MenuItemPerMenuFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface MenuItemPerMenuDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['MenuItemPerMenu'], meta: { name: 'MenuItemPerMenu' } }
  /**
   ...
   * })
  **/
  count<T extends MenuItemPerMenuCountArgs>(
    args?: Prisma.Subset<T, MenuItemPerMenuCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], MenuItemPerMenuCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends MenuItemPerMenuGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, MenuItemPerMenuGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMenuItemPerMenuGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
